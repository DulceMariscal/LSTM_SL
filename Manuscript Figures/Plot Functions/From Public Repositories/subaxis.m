...
if ~isempty(Args.size)
    switch Args.size
        case 'grid'
            Args.SpacingVertical = .01;  Args.SpacingHorizontal = .01;
            Args.MarginLeft = .05;       Args.MarginRight = .01; 
            Args.MarginTop  = .05;       Args.MarginBottom =.05;
        case 'xs'
            Args.SpacingVertical = .01;  Args.SpacingHorizontal = .01;
            Args.MarginLeft = .02; Args.MarginRight = .02; 
            Args.MarginTop = .02;  Args.MarginBottom =.02;
        case 's'
            Args.SpacingVertical = .02;  Args.SpacingHorizontal = .02;
            Args.MarginLeft = .04; Args.MarginRight = .04; 
            Args.MarginTop = .04;  Args.MarginBottom =.04;
        case 'm'
            % Use the default values already present in Args
    end
end
