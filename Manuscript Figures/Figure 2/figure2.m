...
load('../../Results/s82 learningTrace/allv.mat',...
    'systpEst','estimPar','sFuns','usts');
...
[parad, names] = loadParadigm('SHAB',d);

% Load system functions
[~, sFuns.ffun, sFuns.gfun] = sFuns.syspec();
